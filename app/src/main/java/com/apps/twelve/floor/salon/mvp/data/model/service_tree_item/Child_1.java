...
public class Child_1 implements RecursiveItem {
     ...
     * @param children
     */
    public Child_1(Integer serviceId, String title, Integer parentId, Boolean isService, Object price, String imgHref, String description, Integer time, List<Child_2> children) {
        super();
