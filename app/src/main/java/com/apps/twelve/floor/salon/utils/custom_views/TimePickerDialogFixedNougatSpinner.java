...
public class TimePickerDialogFixedNougatSpinner extends TimePickerDialog {
   ...
   */
  public TimePickerDialogFixedNougatSpinner(Context context, OnTimeSetListener listener,
   ...
   * @param is24HourView Whether this is a 24 hour view, or AM/PM.
   */
  public TimePickerDialogFixedNougatSpinner(Context context, int themeResId,
      OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
      ...
      try {
        ...
        if (mode == MODE_SPINNER) {
          TimePicker timePicker =
              (TimePicker) findField(TimePickerDialog.class, TimePicker.class, "mTimePicker").get(
                  this);
          ...
          if (delegate.getClass() != spinnerDelegateClass) {
            ...
            Constructor spinnerDelegateConstructor =
                spinnerDelegateClass.getConstructor(TimePicker.class, Context.class,
